...
const FEATURES = [
  { icon: Camera,    title: 'Fotos organizadas por seção', desc: 'Agrupe por local e disciplina com múltiplas fotos por seção' },
...
export default function Relatorios5SPage() {
  return (
            ...
            <div className="flex flex-col lg:flex-row items-start lg:items-center gap-6 lg:gap-12">
              ...
              <div className="flex-1">
                ...
                <h1 className="text-4xl lg:text-5xl font-black text-white leading-none mb-2">
                  Relatório<span className="text-[#E8291C]"> 5S</span>
                </h1>
                <p className="text-zinc-400 text-base mt-3 leading-relaxed max-w-xl">
                  Crie relatórios fotográficos profissionais das frentes de trabalho.
                  Selecione a obra, organize as fotos por seção e gere um PDF impecável com identidade MSE.
                </p>
              </div>
